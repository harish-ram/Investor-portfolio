...
public class StockDTO {
    ...
    public StockDTO(Stock stock) {
        ...
        this.changePerc = stock.getChangePerc();
        this.targetPrice = stock.getTargetPrice();
        this.divRate = stock.getDivRate();
        this.divGrowth = stock.getDivGrowth();
        this.yearsDivGrowth = stock.getYearsDivGrowth();
        this.creditRating = stock.getCreditRating().name();
        this.comment = stock.getComment();
        this.level = stock.getLevel().name();
    }
